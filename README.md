...
- [oreixa](https://github.com/oreixa) — Security, performance, architecture and UX improvements (PRs #1–#8)
- [Claude](https://claude.ai) by Anthropic — Code security review, architecture guidance and documentation
